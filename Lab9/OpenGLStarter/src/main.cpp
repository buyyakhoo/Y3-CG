...
//     Mesh* obj1 = new Mesh();
//     obj1->CreateMesh(vertices1, indices1, 12, 12);
//     meshList.push_back(obj1);

//     // --- Object 2: flat triangle ---
//     GLfloat vertices2[] =
//     {
//         -0.5f, 0.0f, 0.0f,
//          0.5f, 0.0f, 0.0f,
...
int main()
{
    ...
    if (!data1) {
        std::cout << "Failed to load texture1: container.jpg" << std::endl;
    } else {
    ...
    if (!data2) {
        std::cout << "Failed to load texture2: cloth.jpg" << std::endl;
    } else {
        GLenum format = GL_RGB;
        if (nrChannels2 == 1)
            format = GL_RED;
    ...
    {   
        ...
        for (int i=0; i<10; i++) {
            ...
            GLuint uniformTexture2 = shaderList[0].GetUniformLocation("texture2");
